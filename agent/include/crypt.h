...
VOID XorCipher( _In_ PBYTE  pBinary, _In_ UINT64 sSize, _In_ PBYTE  pbKey, _In_ UINT64 sKeySize );
VOID XorStack( PVOID StackBase, PVOID StackLimit );
...
#define LOAD32L(x, y)                            \
  do { x = ((ULONG)((y)[3] & 255)<<24) | \
           ((ULONG)((y)[2] & 255)<<16) | \
           ((ULONG)((y)[1] & 255)<<8)  | \
           ((ULONG)((y)[0] & 255)); } while(0)
...
#define LOAD32H(x, y)                            \
  do { x = ((ULONG)((y)[0] & 255)<<24) | \
           ((ULONG)((y)[1] & 255)<<16) | \
           ((ULONG)((y)[2] & 255)<<8)  | \
           ((ULONG)((y)[3] & 255)); } while(0)
