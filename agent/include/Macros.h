...
//
#define CST_8( x )  ( ( INT8 ) ( X ) )
#define CST_16( x ) ( ( INT16 ) ( x ) )
#define CST_32( x ) ( ( INT32 ) ( x ) )
#define CST_64( x ) ( ( INT64 ) ( x ) )
#define CST_U8( x ) ( ( UINT8 ) ( X ) )
#define CST_U16( X ) ( ( UINT16 ) ( x ) )
#define CST_U32( x ) ( ( UINT32 ) ( x ) )
#define CST_U64( x ) ( ( UINT64 ) ( x ) )
